...
merge(config.tasks, {
    save:{text:"сохранить", tooltip:"Сохранить измения в тиддл-файл", action:saveChanges},
    sync:{text:"sync", tooltip:"Synchronise changes with other TiddlyWiki files and servers", content:'<<sync>>'},
    importTask:{text:"импорт", tooltip:"Импортировать записки и плагины из сторонних тиддл-файлов или серверов", content:'<<importTiddlers>>'},
    tweak:{text:"настроить", tooltip:"Настроить внешний вид и поведение TiddlyWiki", content:'<<options>>'},
    plugins:{text:"плагины", tooltip:"Управление установленными плагинами", content:'<<plugins>>'}
});
// Options that can be set in the options panel and/or cookies
merge(config.optionsDesc, {
    chkBackstage:"Открыта или нет кулуарная область",
    chkDisplayStartupTime:"Показывать время загрузки тиддл-файла",
    txtUserName:"Имя, которым будут подписаны все записи",
    chkRegExp:"Разрешить регулярные выражения в поиске",
    chkCaseSensitiveSearch:"Регистрозависимый поиск",
    chkAnimate:"Разрешить анимацию",
    chkSaveBackups:"Делать резервные копии при сохрании изменении",
    chkAutoSave:"Автоматически сохранять изменения",
    chkGenerateAnRssFeed:"Создавать RSS-ленту при сохранении",
    chkSaveEmptyTemplate:"Создавать пустой шаблон при сохранении изменений",
    chkOpenInNewWindow:"Открывать внешние ссылки в новом окне",
    chkToggleLinks:"Нажатие на ссылку открытой записки закрывает ее",
    chkHttpReadOnly:"Скрывать возможности редактирования при доступе к файлу через HTTP",
    chkForceMinorUpdate:"Не изменять имя пользователя и дату при редактировании записки",
    chkConfirmDelete:"Требуется подтверждение для удаление записок",
    chkInsertTabs:"Использовать клавишу TAB для вставки табуляции вместо перехода между полями редактирования",
    txtBackupFolder:"Имя папки для сохранения резервных копий",
    txtMaxEditRows:"Максимальное количество строк в окне редактирования",
    txtFileSystemCharSet:"Кодовая страница по умолчанию для сохранения изменений (только Firefox/Mozilla)"});
merge(config.messages, {
    customConfigError:"Какие-то проблемы при загрузке плагинов. Смотрите PluginManager для деталей",
    pluginError:"Error: %0",
    pluginDisabled:"Плагин не запущен так, как отменен при помощи тега 'systemConfigDisable'",
    pluginForced:"Плагин принудительно запущен при помощи тега 'systemConfigForce'",
    pluginVersionError:"Плагин не запущен, так как требуется более новая версия TiddleWiki",
    nothingSelected:"Ничего не выбрано. Вы должны выбрать один или более элементов.",
    savedSnapshotError:"TiddlyWiki сохранен некорректно. Пожалуйста смотрите http://www.tiddlywiki.com/#DownloadSoftware для дополнительной информации",
    subtitleUnknown:"(unknown)",
    undefinedTiddlerToolTip:"Записка '%0' еще не существует",
    shadowedTiddlerToolTip:"Записка '%0' еще не существует, но относится к предопределенному скрытому типу",
    ...
    backupFailed:"Ощибка при сохранении резервной копии",
    rssSaved:"RSS-лента сохранена",
    rssFailed:"Ошибка при сохранении файла RSS-ленты",
    emptySaved:"Пустой шаблон сохранен",
    emptyFailed:"Ошибка при сохранении файла с пустым шаблоном",
    mainSaved:"Главный TiddlyWiki файл сохранен",
    mainFailed:"Ошибка при сохранении главного TiddlyWiki файла. Изменения не сохранены!",
    macroError:"Ошибка в макросе <<\%0>>",
    macroErrorDetails:"Ошибка при исполнении макроса <<\%0>>:\n%1",
    missingMacro:"Нет такого макроса",
    overwriteWarning:"Записка '%0' уже существует. Выберите OK для ее перезаписи",
    unsavedChangesWarning:"ВНИМАНИЕ! Есть несохраненные изменения в TiddlyWiki\n\nВыберите OK для сохранения\nВыберите CANCEL для отмены",
    confirmExit:"--------------------------------\n\nЕсть несохраненные изменения в TiddlyWiki. Если вы продолжите, то все изменения будут утеряны.\n\n--------------------------------",
    saveInstructions:"SaveChanges",
    unsupportedTWFormat:"Unsupported TiddlyWiki format '%0'",
    tiddlerSaveError:"Ошибка при сохране '%0'",
    tiddlerLoadError:"Ошибка при загрузке записки '%0'",
    wrongSaveFormat:"Cannot save with storage format '%0'. Using standard format for save.",
    invalidFieldName:"Неправильное имя поля %0",
...
config.messages.backstage = {
    ...
    close:{text:"закрыть", tooltip:"Close the backstage area"},
    prompt:"backstage: ",
    decal:{
...
config.messages.listView = {
    ...
    previewUnavailable:"(препросмотр недоступен)"
};
config.messages.dates.months = ["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"];
...
merge(config.views.wikified.tag, {
    labelNoTags:"нет тегов",
    labelTags:"теги: ",
    openTag:"Открыть тег '%0'",
    tooltip:"Посмотреть записки, помеченные тегом '%0'",
    openAllText:"Открыть все",
    openAllTooltip:"Открыть все остальные записки с этим тегом",
    popupNone:"Нет других записок, помеченных как '%0'"});
merge(config.views.wikified, {
    defaultText:"Записка '%0' еще не существует. Двойной щелчок мышью создаст ее.",
    defaultModifier:"(missing)",
    shadowModifier:"(built-in shadow tiddler)",
    dateFormat:"DD MMM YYYY",
    createdPrompt:"создана"});
merge(config.views.editor, {
    tagPrompt:"Введите тэги, разделяя их пробелами, [[используя такие двойные скобки]] если необходимо, или добавьте существующие",
    defaultText:"Type the text for '%0'"});
merge(config.views.editor.tagChooser, {
    text:"тэги",
    tooltip:"Выберите существующие теги для добавления к этой записке",
    popupNone:"Ни одного тега не определено!",
    tagTooltip:"Добавить тег '%0'"});
merge(config.messages, {
    sizeTemplates:[
...
merge(config.macros.search, {
    label:"поиск",
    prompt:"поиск по всем запискам",
    accessKey:"F",
    successMsg:"%0 записок найдено по запросу %1",
    failureMsg:"Записок по запросу %0 не найдено"});
merge(config.macros.tagging, {
    label:"Записки с тегом: '%0'",
    labelNotTag:"not tagging",
    tooltip:"Записки с тегом: '%0'"});
merge(config.macros.timeline, {
    dateFormat:"DD MMM YYYY"});
merge(config.macros.allTags, {
    tooltip:"Show tiddlers tagged with '%0'",
    noTags:"There are no tagged tiddlers"});
config.macros.list.all.prompt = "Все записки в алфавитном порядке";
...
merge(config.macros.closeAll, {
    label:"закрыть все",
    prompt:"Закрыть все записки (кроме редактируемых)"});
merge(config.macros.permaview, {
    label:"постоянный адрес",
    prompt:"Ссылка на URL, указывающий все открытые сейчас записки"});
merge(config.macros.saveChanges, {
    label:"Сохранить",
    prompt:"Сохранить все изменения в тиддл-файл",
    accessKey:"S"});
merge(config.macros.newTiddler, {
    label:"новая",
    prompt:"Создать новую записку",
    title:"Новая",
    accessKey:"N"});
merge(config.macros.newJournal, {
    label:"Записка 'сегодня'",
    prompt:"Создать новую записку с заголовком, содержащим сегодняшнюю дату",
    accessKey:"J"});
merge(config.macros.options, {
    wizardTitle:"Настроить дополнительные опции",
    step1Title:"Эти опции будут сохранены в куки-файлах в браузере",
...
merge(config.macros.plugins, {
    ...
    step1Title:"Текущие загруженные плагины",
    step1Html:"<input type='hidden' name='markList'></input>", // DO NOT TRANSLATE
    skippedText:"(This plugin has not been executed because it was added since startup)",
    noPluginText:"Никаких плагинов не установлено",
    confirmDeleteText:"Вы уверены, что хотите удалить эти плагины:\n\n%0?",
    removeLabel:"remove systemConfig tag",
    removePrompt:"Удалить тэг systemConfig",
    deleteLabel:"удалить",
    deletePrompt:"Удалить эти записки навсегда?",
    listViewTemplate:{
        columns:[
...
merge(config.macros.toolbar, {
    moreLabel:"еще",
    morePrompt:"Открыть дополнительные команды"
});
merge(config.macros.refreshDisplay, {
    label:"обновить",
    prompt:"Перерисовать текущий TiddlyWiki"
});
merge(config.macros.importTiddlers, {
    readOnlyWarning:"Импорт в файл, находящийся в режиме read-only невоможен. Попробуйте открыть файл по пути file:// URL",
    wizardTitle:"Импорт записок из другого файла или сервера",
    step1Title:"Шаг 1: Укажите сервер или тиддл-файл с записками",
    step1Html:"Укажите тип сервера: <select name='selTypes'><option value=''>Выбрать...</option></select><br>Введите URL или путь тут: <input type='text' size=50 name='txtPath'><br>...или выберите файл: <input type='file' size=50 name='txtBrowse'><br><hr>...or select a pre-defined feed: <select name='selFeeds'><option value=''>Choose...</option></select>",
    openLabel:"открыть",
    openPrompt:"Открыть соединение с файлом или сервером",
    openError:"При анализе тиддл-файла обнаружены ошибки",
    statusOpenHost:"Opening the host",
    statusGetWorkspaceList:"Getting the list of available workspaces",
    step2Title:"Step 2: Choose the workspace",
    step2Html:"Enter a workspace name: <input type='text' size=50 name='txtWorkspace'><br>...or select a workspace: <select name='selWorkspace'><option value=''>Choose...</option></select>",
    cancelLabel:"отмена",
    cancelPrompt:"Отменить импорт",
    statusOpenWorkspace:"Opening the workspace",
    statusGetTiddlerList:"Получение списка доступных записок",
    step3Title:"Шаг 3: Выберите записки для импорта",
    step3Html:"<input type='hidden' name='markList'></input><br><input type='checkbox' checked='true' name='chkSync'>Keep these tiddlers linked to this server so that you can synchronise subsequent changes</input><br><input type='checkbox' name='chkSave'>Save the details of this server in a 'systemServer' tiddler called:</input> <input type='text' size=25 name='txtSaveTiddler'>",
    importLabel:"импорт",
    importPrompt:"Импортировать указанные записки",
    confirmOverwriteText:"Вы уверены, что хотите импортировать эти записки:\n\n%0",
    step4Title:"Шаг 4: Импортируется %0 записка(ок)",
    step4Html:"<input type='hidden' name='markReport'></input>", // DO NOT TRANSLATE
    doneLabel:"закрыть",
    donePrompt:"закрыть этот мастер",
    statusDoingImport:"Записки импортируются",
    statusDoneImport:"Все записки импортированы",
    systemServerNamePattern:"%2 on %1",
    systemServerNamePatternNoWorkspace:"%1",
    confirmOverwriteSaveTiddler:"Записка '%0' уже существует. Нажмите 'OK' для ее перезаписи содержимым этого сервера, или 'Cancel' чтобы оставить ее неизменной",
    serverSaveTemplate:"|''Type:''|%0|\n|''URL:''|%1|\n|''Workspace:''|%2|\n\nЭта записка создана автоматически и содержит детали операции экспорта/импорта",
...
merge(config.macros.sync, {
    ...
    step1Title:"Выберите записки для синхронизации",
    step1Html:"<input type='hidden' name='markList'></input>", // DO NOT TRANSLATE
    syncLabel:"sync",
    syncPrompt:"Синхронизировать указанные записки",
    ...
    syncStatusList:{
        ...
        notFound:{text:"Не найдены на сервере", color:'#ffff80'},
        putToServer:{text:"Сохранено обновление на сервер", color:'#ff80ff'},
        gotFromServer:{text:"Получено обновление с сервера", color:'#80ffff'}
    }
});
...
merge(config.commands.closeTiddler, {
    text:"закрыть",
    tooltip:"Закрыть записку"});
merge(config.commands.closeOthers, {
    text:"закрыть другие",
    tooltip:"Закрыть все записки кроме этой"});
merge(config.commands.editTiddler, {
    text:"правка",
    tooltip:"Редактировать записку",
    readOnlyText:"просмотр",
    readOnlyTooltip:"Просмотр исходного кода записки"});
merge(config.commands.saveTiddler, {
    text:"сохранить",
    tooltip:"Сохранить измения в записке"});
merge(config.commands.cancelTiddler, {
    text:"отмена",
    tooltip:"Отменить все изменения в записке",
    warning:"Вы уверены, что хотите отменить измения в записке '%0'?",
    readOnlyText:"отмена",
    readOnlyTooltip:"Завершить просмотр исходного кода записки"});
merge(config.commands.deleteTiddler, {
    text:"удалить",
    tooltip:"Удалить записку",
    warning:"Вы уверены, что хотите удалить записку '%0'?"});
merge(config.commands.permalink, {
    text:"якорь",
    tooltip:"Постоянная ссылка (якорь) на эту записку"});
merge(config.commands.references, {
    text:"ссылки",
    tooltip:"Посмотреть записки, ссылающиеся на эту",
    popupNone:"Нет записок, ссылающихся на эту"});
merge(config.commands.jump, {
    text:"переход",
    tooltip:"Переход на другую открытую записку"});
merge(config.commands.syncing, {
    text:"синхронизация",
    tooltip:"Управление синхронизацией этой записки с другим сервером или файлом",
...
merge(config.commands.fields, {
    text:"поля",
    tooltip:"Посмотреть дополнительные поля записки",
    emptyText:"Дополнительных полей у записки нет",
    listViewTemplate:{
        columns:[
...
merge(config.shadowTiddlers, {
    ...
    SiteSubtitle:"нелинейная персональная записная книжка",
    SiteUrl:"http://www.tiddlywiki.com/",
    SideBarOptions:'<<search>><<closeAll>><<permaview>><<newTiddler>><<newJournal "DD MMM YYYY">><<saveChanges>><<slider chkSliderOptionsPanel OptionsPanel "опции »" "Change TiddlyWiki advanced options">>',
...
function main() {
    ...
    if (config.options.chkDisplayStartupTime) {
        displayMessage("Загружено " + (t2 - t1) + " ms");
...
config.macros.search.onKeyPress = function (ev) {
    ...
    if (this.value.length > 2) {
        if (this.value != this.getAttribute("lastSearchText")) {
            ...
            var txt = this;
            config.macros.search.timeout = setTimeout(function () {
                config.macros.search.doSearch(txt);
            }, 500);
        }
    } else {
        if (config.macros.search.timeout)
...
function StringFieldAccess(n, readOnly) {
    this.set = readOnly ?
            function (t, v) {
                if (v != t[n]) throw config.messages.fieldCannotBeChanged.format([n]);
            } :
            function (t, v) {
                if (v != t[n]) {
                    t[n] = v;
...
// consume = true;
            displayMessage("Exit by Escape pressing disabled!");
            break;
    }
...
config.macros.importTiddlers.restart = function (wizard) {
    ...
    wizard.setButtons([
        {caption:this.openLabel, tooltip:this.openPrompt, onClick:config.macros.importTiddlers.onOpen}
    ]);
};
...
config.macros.importTiddlers.onOpen = function (e) {
    ...
    ], config.macros.importTiddlers.statusOpenHost);
    return false;
};
config.macros.importTiddlers.onOpenHost = function (context, wizard) {
    ...
    wizard.setButtons([
        {caption:config.macros.importTiddlers.cancelLabel, tooltip:config.macros.importTiddlers.cancelPrompt, onClick:config.macros.importTiddlers.onCancel}
    ], config.macros.importTiddlers.statusGetWorkspaceList);
};
config.macros.importTiddlers.onGetWorkspaceList = function (context, wizard) {
    ...
    wizard.setButtons([
        {caption:config.macros.importTiddlers.openLabel, tooltip:config.macros.importTiddlers.openPrompt, onClick:config.macros.importTiddlers.onChooseWorkspace}
    ]);
};
...
config.macros.importTiddlers.onChooseWorkspace = function (e) {
    ...
    wizard.setButtons([
        {caption:config.macros.importTiddlers.cancelLabel, tooltip:config.macros.importTiddlers.cancelPrompt, onClick:config.macros.importTiddlers.onCancel}
    ], config.macros.importTiddlers.statusOpenWorkspace);
    return false;
};
config.macros.importTiddlers.onOpenWorkspace = function (context, wizard) {
    ...
    wizard.setButtons([
        {caption:config.macros.importTiddlers.cancelLabel, tooltip:config.macros.importTiddlers.cancelPrompt, onClick:config.macros.importTiddlers.onCancel}
    ], config.macros.importTiddlers.statusGetTiddlerList);
};
...
// Extract data for the listview
    ...
    listedTiddlers.sort(function (a, b) {
